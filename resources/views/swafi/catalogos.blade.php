...
<section class="card form-card">
  <div class="section-title">
    ...
    <div class="tabs">
      <span class="tab">Proveedores</span>
      <span class="tab">Plantas</span>
      <span class="tab">Centros de costo</span>
      <span class="tab">Responsables</span>
    </div>
  </div>
  ...
  <div class="action-group">
    ...
    <span class="tab">Limpiar</span>
  </div>
</section>

<section class="card table-card" style="margin-top:20px">
  <div class="section-title">
    <h2>Consulta de catálogos registrados</h2>
    <div class="tabs">
  ...
  <div class="query-toolbar">
    <div class="query-grid query-grid-four">
      <label><span>Catálogo</span><select><option>Todos</option><option>Proveedores</option><option>Plantas</option><option>Centros de costo</option><option>Responsables</option></select></label>
      <label><span>Estatus</span><select><option>Todos</option><option>Activo</option><option>Inactivo</option></select></label>
      <label><span>Registros desde</span><input type="number" value="1"></label>
      <label><span>Registros hasta</span><input type="number" value="1500"></label>
    </div>
    <div class="action-group">
  ...
  <table>
    <thead>
      <tr><th>Catálogo</th><th>Registros</th><th>Estatus</th><th>Acciones</th></tr>
    </thead>
    <tbody>
      ...
      <tr><td>Responsables</td><td>88</td><td><span class="pill ok">Activo</span></td><td><div class="table-actions"><a href="#">Consultar</a><a href="#">Editar</a><a href="#">Eliminar</a></div></td></tr>
    </tbody>
  </table>

  <div class="table-footer">
    <div class="table-summary">Mostrando 1–10 de 1,725 resultados</div>
