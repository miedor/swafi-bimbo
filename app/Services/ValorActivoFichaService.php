    ...
    public function pdfPayload(object $record): array
    {
        ...
        return [
            ...
            'rows' => [
                ...
                ['Valores', 'Depreciación acumulada (Oracle ERP)', $this->money($record->depreciacion_acumulada, $moneyCurrency)],
                ['Valores', 'Valor en libros (Oracle ERP)', $this->money($record->valor_en_libros, $moneyCurrency)],
