...
class UpdateSecurityRoleStatusRequest extends SecurityAdministrationRequest
{
    ...
    {
        return [
            'estatus.required' => 'Debes indicar el nuevo estatus del rol.',
            'estatus.in' => 'La operación solicitada para el rol no es válida.',
