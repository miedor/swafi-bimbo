...
Route::get('/olvide-contrasena', [PasswordResetController::class, 'showForgotForm'])
    ->name('password.request');

Route::post('/olvide-contrasena', [PasswordResetController::class, 'sendResetLink'])
    ->name('password.email');
...
Route::middleware('swafi.auth')->group(function () {
    ...
    */
    ...
    Route::get('/perfil/avatar', [ProfileController::class, 'avatar'])
        ->name('perfil.avatar');

    Route::delete('/perfil/avatar', [ProfileController::class, 'destroyAvatar'])
        ->name('perfil.avatar.destroy');
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | M01 - Gestión de expedientes
    |--------------------------------------------------------------------------
    */

    Route::get('/registro-individual', [RegistroIndividualController::class, 'create'])
        ->name('registro-individual');

    Route::post('/registro-individual', [RegistroIndividualController::class, 'store'])
        ->name('registro-individual.store');

    Route::get('/registro-masivo', [RegistroMasivoController::class, 'index'])
        ->name('registro-masivo');

    Route::post('/registro-masivo/importar', [RegistroMasivoController::class, 'importar'])
        ->name('registro-masivo.importar');

    Route::get('/registro-masivo/plantilla-csv', [RegistroMasivoController::class, 'plantillaCsv'])
        ->name('registro-masivo.plantilla');
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Edición y eliminación de expedientes
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Observaciones y validación cruzada
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    Route::get('/valores-fiscales-financieros', [ValoresActivoController::class, 'index'])
        ->name('valores');

    Route::post('/valores-fiscales-financieros', [ValoresActivoController::class, 'store'])
        ->name('valores.store');

    Route::get('/valores-fiscales-financieros/plantilla-csv', [ValoresActivoController::class, 'plantillaCsv'])
        ->name('valores.plantilla');

    Route::post('/valores-fiscales-financieros/importar', [ValoresActivoController::class, 'importar'])
    ...
    Route::get('/ubicacion-inventario', [UbicacionInventarioController::class, 'index'])
        ->name('ubicacion');

    Route::post('/ubicacion-inventario/movimiento', [UbicacionInventarioController::class, 'storeMovimiento'])
        ->name('ubicacion.movimiento');

    Route::post('/ubicacion-inventario/inventario', [UbicacionInventarioController::class, 'storeInventario'])
        ->name('ubicacion.inventario');
    ...
    */
    ...
    Route::get('/busqueda-avanzada', [BusquedaController::class, 'index'])
        ->name('busqueda');

    Route::get('/detalle-expediente/{expediente?}', [BusquedaController::class, 'show'])
    ...
    /*
    |--------------------------------------------------------------------------
    | M04 - Administración y seguridad
    |--------------------------------------------------------------------------
    */
    ...
    Route::post('/catalogos', [CatalogosController::class, 'store'])
        ->name('catalogos.store');

    Route::post('/catalogos/importar', [CatalogosController::class, 'importar'])
        ->name('catalogos.importar');

    Route::get('/catalogos/plantilla-csv', [CatalogosController::class, 'plantillaCsv'])
    ...
    Route::get('/seguridad-acceso', [SeguridadController::class, 'index'])
        ->name('seguridad');

    Route::post('/seguridad-acceso/usuarios', [SeguridadController::class, 'storeUser'])
        ->name('seguridad.usuarios.store');

    Route::delete('/seguridad-acceso/usuarios/{user}', [SeguridadController::class, 'destroyUser'])
        ->whereNumber('user')
        ->name('seguridad.usuarios.destroy');

    Route::post('/seguridad-acceso/roles', [SeguridadController::class, 'storeRole'])
        ->name('seguridad.roles.store');
